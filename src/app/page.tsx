    ...
    <div className="h-screen text-black">
      ...
      <div className="my-8 px-14">
        ...
        <div className="block md:flex justify-between mx-10 my-3 py-10  animate-swipeInBottom">
          <div className="flex flex-col items-center  bg-green-800 text-slate-100 px-3 py-5 w-[200px] h-[230px] rounded-xl transition delay-150 duration-300 ease-in-out transform hover:scale-105">
